...
import io.github.mathter.smuzy.annotation.AnnotationReferencedPropertyResolverFactory;
import io.github.mathter.smuzy.annotation.ReferencedProperties;
import io.github.mathter.smuzy.annotation.ReferencedProperties.Property;
...
public class AnnotationReferencedPropertyResolverFactoryTest {
    ...
    public void test() {
        ...
        Collection<io.github.mathter.smuzy.Property> properties = propertyResolver.resolve(TestBean.class);
